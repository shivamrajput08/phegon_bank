...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Response<?> createTransaction(TransactionRequest transactionRequest) {
        ...
        transaction.setTransactionTypes(transactionRequest.getTransactionTypes());
        transaction.setAmount(transactionRequest.getAmount());
        transaction.setDescription(transactionRequest.getDescription());

        switch (transactionRequest.getTransactionTypes()) {
    ...
    private void sendTransactionNotifications(Transaction tnx) {
        ...
        if (tnx.getTransactionTypes() == TransactionTypes.DEPOSIT) {
        ...
        } else if (tnx.getTransactionTypes() == TransactionTypes.WITHDRAWAL) {
            ...
            notificationService.sendEmail(notificationEmailToSendOut, user);
        } else if (tnx.getTransactionTypes() == TransactionTypes.TRANSFER) {
